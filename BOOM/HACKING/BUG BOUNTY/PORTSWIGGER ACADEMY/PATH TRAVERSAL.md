...
Find the url image of the product 
and fuzz through it to get the /etc/passwd
...
Just provide the file path in the url for displaying 
Not much to do Just
...
Just use  `....//` to bypass inner sequence filters.
GET /image?filename=....//....//....//etc/passwd HTTP/2
...
A base start with /var/www/images will already be there then just
../../
