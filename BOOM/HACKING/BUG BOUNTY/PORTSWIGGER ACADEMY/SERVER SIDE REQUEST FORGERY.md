...
![[Pasted image 20260412113326.png]]
...
Just change the StockApi url to 
...
"a" has been double encoded 
Mostly hit and trial method would work
...
just add `https://` to the link provided by the collaborator and click start poll
