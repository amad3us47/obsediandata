...
Recon
- [ ] Get ASN for IP ranges([amass](https://github.com/OWASP/Amass),[anslookup]([yassineaboukir/Asnlookup: Leverage ASN to look up IP addresses (IPv4 & IPv6) owned by a specific organization for reconnaissance purposes, then run port scanning on it. (github.com)](https://github.com/yassineaboukir/Asnlookup)),[metabigor](https://github.com/j3ssie/metabigor),[bgp](https://bgp.he.net/))
...
- [ ] Find the version of the Web Server
...
- [ ] Check how the application is handing 4xx & 5xx errors
...
Test Cloud Storage
- [ ] Check the sensitive paths for AWS
...
- [ ] Ensure the same user or identity can't register again an again
...
- [ ] Check the response for both valid and invalid username
...
- [ ] Test for URL redirection by creating a new subdomain with the same as the targe
...
- [ ] Try to bypass 2FA by using a null or empty entry or 000000
